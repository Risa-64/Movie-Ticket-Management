...
<html>
<head>
    <title>Pending Ticket List</title>
 ...
 <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-11">
          ...
          <div class="row">
            <div class="col-md-6">
              <h4><b>Pending Ticket List</b></h4>
            </div>
            <div class="col-md-12">
              <?php if(isset($_GET['tstatus'])){ ?>
                <hr>
                <h5 style="color:green;">Ticket has been successfully confirmed.</h5>
              <?php } ?>
            </div>
          </div>
          <hr>
          ...
          <tbody>
             <?php 
            $i=1;
            $result = "SELECT tb_ticket.*, tb_user.u_name, tb_movie.m_name FROM tb_ticket left join tb_user on tb_user.u_id = tb_ticket.user_id  left join tb_movie on tb_movie.m_id = tb_ticket.movie_id WHERE tb_ticket.t_status = 0";
                ...
                while ($row=mysqli_fetch_assoc($result))
                  {
                    ...
                    <tr>
                        ...
                        <td style="line-height: 10px; text-align: center;">
                          <a onclick="return confirm('Are you sure to confirm Payment & Ticket?')" href="confirm_ticket.php?id=<?php echo base64_encode($row['t_id']); ?>">Confirm</a>
                        </td>
