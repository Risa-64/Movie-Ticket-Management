             ...
             <table id="users" class="table table-striped table-bordered table-hover table-sm">
              <thead>
                <tr>
                  ...
                  <td style="text-align: center;"> Seat title</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th style="text-align: center;"><?php echo $row['s_name'];?> </th>
                  <th style="text-align: center;"><?php echo $row['s_price'];?> </th>
                  <td style="line-height: 10px;">
                    <button class="btn-warning" data-toggle="modal" data-target="#editmodal_<?php echo $row['s_id'];?>">Edit
                    </button>
                    <button type="button" class="btn-danger"data-toggle="modal" data-target="#deletemodal_<?php echo $row['s_id'];?>">Delete
                    </button>
                  </tr>
                    ...
                    <form method="POST" action="connection.php">
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <input type="text" name="cat_name" value="<?php  echo $row['s_name'];?>">
                          </div>
                        </div>
                        <div class="modal-footer">
                          <button type="submit" class="btn btn-primary" name="seatsave">Save changes</button>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                            <form method="POST" action="connection.php">
                            <label>Category: </label>
                            <input type="text" name="" value="<?php  echo $row['s_name'];?>">
                          </div>
                        </div>
                        <div class="modal-footer">
